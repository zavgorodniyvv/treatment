...
class RecurrencePatternParserTest {
    ...
    void testShouldGenerate(String  pattern) {
        assertTrue(parser.shouldGenerate(pattern, currentTime, endTime).isPresent(), "True should be returned for pattern: " + pattern);
    }
    ...
    void testShouldNotGenerateBecauseOfNotValidValues(String pattern) {
        assertFalse(parser.shouldGenerate(pattern, currentTime, endTime).isPresent(), "False should be returned for pattern: " + pattern);
    }
    ...
    void testShouldReturnFalse(String pattern) {
        assertFalse(parser.shouldGenerate(pattern, currentTime, endTime).isPresent());
    }
